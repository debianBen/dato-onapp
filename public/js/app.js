	...
	class Component extends App{
	  ...
	  <ul class="w3-navbar w3-white w3-wide w3-padding-8 w3-card-2">
	    <li>
	      <a href="#home" class="w3-margin-left"><b>CODA</b>Prog</a>
	    </li>
	    <!-- Float links to the right. Hide them on small screens -->
	    <li class="w3-right w3-hide-small">
	      <a href="#projects" class="w3-left" onclick="component.showLandingPage()">HOME</a>
	      <a href="#about" class="w3-left" onclick="component.showProgPage()" >LANGUAGE</a>
	      <a href="#contact" class="w3-left w3-margin-right" onclick="component.showProgCreate()" >ADD</a>
	    </li>
	  </ul>
	</div>
			<!-- END NAVIGATION -->
